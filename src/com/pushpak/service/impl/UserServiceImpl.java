package com.pushpak.service.impl;
...
import com.pushpak.constants.IUserConstants;
import com.pushpak.service.UserService;
import com.pushpak.utility.DBUtil;
import com.pushpak.utility.MailMessage;

public class UserServiceImpl implements UserService {

	@Override
	public String registerUser(String userName, Long mobileNo, String emailId, String address, int pinCode,
			String password,InputStream profile_photo) {
	...
	public String registerUser(UserBean user) {
		...
		try {
			...
			ps.setBlob(7, user.getProfile_photo());
	...
	@Override
	public byte[] getUserProfilePhoto(String userName) {
	    byte[] image = null;
	    Connection conn = DBUtil.provideConnection();
	    PreparedStatement ps = null;
	    ResultSet rs = null;
	    ...
	    try {
	        ps = conn.prepareStatement("SELECT profile_photo FROM user WHERE email = ?");
	        ps.setString(1, userName);
	        rs = ps.executeQuery();

	        if (rs.next()) {
	            image = rs.getBytes("profile_photo");
	        }
